                    ...
                    <View style={styles.card}>
                        <View style={styles.card__header}>
                            ...
                            <View>
                                ...
                                <Image source={require('../styles/photos/profilePicture.webp')} style={styles.card__header__img} />
                                <Text style={styles.card__header__create}>Alex Slur</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.card__bottom}>
                            <View style={styles.card__bottom__info}>
                                ...
                                <Text style={styles.card__bottom__text}>5 people joined</Text>
                            </View>
                            <View style={styles.card__bottom__info}>
                                <Check name="check-circle" size={18} color={Themes.light__gray.color}/>
                                <Text style={styles.card__bottom__text}>2 other goals</Text>
                            </View>
                            <View style={styles.card__bottom__info}>
                                <Watch name="stopwatch" size={18} color={Themes.light__gray.color}/>
                                <Text style={styles.card__bottom__text}>10 days left</Text>
                            </View>
                        </View>
                    </View>
                </View>
